      ...
      <div className="container max-w-3xl mx-auto">
        <Card className="shadow-card">
          <CardHeader className="text-center">
            <img src={helaLogo} alt="Hela Loans" className="w-16 h-16 object-contain mx-auto mb-4" />
          ...
          <CardContent className="space-y-6">
            <div className="bg-muted p-6 rounded-xl max-h-[70vh] overflow-y-auto space-y-6 text-sm">
              ...
              <div className="text-center border-b border-border pb-4">
                <img src={helaLogo} alt="Hela Loans" className="w-12 h-12 object-contain mx-auto mb-3" />
              ...
              <div className="space-y-3">
                ...
                <div className="space-y-2 pl-4">
                  ...
                  <ul className="list-disc pl-6 space-y-1 text-muted-foreground">
                    ...
                    <li><strong>System</strong> means Hela Loans's electronic communications software;</li>
